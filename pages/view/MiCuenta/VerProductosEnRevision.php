...
<meta charset="UTF-8">
    ...
    <title>Productos en Revisión</title>
</head>
...
<body>
    ...
    <?php 
        ...
        // print_r($publicaciones->ListarProductosEnRevision($_SESSION['usuario-cliente']["id"]));
    ...
    <div class="container-fluid">
        <div class="row mt-4">
            <div class="col-12 col-sm-10  mx-auto">
                <h1 class="h1 text-center mb-4">Productos en Revision</h1>
                ...
                <div class="mt-4 table-responsive-sm">
                    <table class="table table-bordered text-center">
                        ...
                        <tbody class="align-middle table-sm">
                            <?php
                                $condicion = $publicaciones->ListarProductosEnRevision($_SESSION['usuario-cliente']['id']);
                                // $totalCompra = 0;
                                if($condicion){
