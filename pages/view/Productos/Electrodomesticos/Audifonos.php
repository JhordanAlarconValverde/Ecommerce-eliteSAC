...
<body>
    ...
    <?php
        ...
        require '../../../../pages/model/Audifonos/Audifonos.php';
        $objeto = new Audifonos();
        $audifonos = $objeto->ListarAudifonos();
    ...
    <div class="container-fluid container_fluid_keyframe830w mt-4">
        ...
        <h1 class="h1 text-center">Audífonos</h1>
        ...
        <div class="mt-4">
            <div class="d-flex">
                <div style="width:13rem;" class="filtradoby_keyframe830w2">
                    ...
                    <div>
                        <div class="d-flex justify-content-between align-items-center py-2 drop_categoria" style="cursor: pointer" >
                            <div class="fs-6 fw-bolder">Audífonos</div>
                ...
                <div class="w-100 ps-4">
                    <div style="display: grid;grid-template-columns: repeat(auto-fill,minmax(280px, 4fr));grid-gap: 2.1rem 1.8rem;" id="container-show-producto" idCategoria="<?=$precio_mas_bajo->idCategoria?>">
                        <?php
                            foreach ($audifonos as $datos) { ?>
